// ============================================================================
//  DIY Reflow Oven Controller — Compact Flat Bench Enclosure (v9, X1C Fit)
...
kp_window_y = 70;           // shorter than screw spacing so screw bosses land on solid lid
kp_lid_boss_h = 7;
kp_lid_boss_dia = 9;
kp_insert_dia = 4.5;
kp_insert_depth = 5;
...
module lid_assembly_orientation() {
    // Converts print-ready lid into installed orientation:
    // exterior/top face becomes Z=box_h, interior bosses point downward.
    translate([0, 0, box_h]) mirror([0, 0, 1]) lid_print_orientation();
}
...
module print_layout() {
    bottom_shell();
    translate([box_w + 15, 0, 0]) lid_print_orientation();
